(function(root,factory){
  ...
  function parse(text){
    ...
    return{parser:"garmin-v2.5.0",screen,found:Object.values(fields).filter(x=>x.value!=null).length,data,fields,raw_text:raw};
  }
  function merge(results){
    ...
    return{parser:"garmin-v2.5.0-merge",found:Object.values(data).filter(v=>v!=null).length,data,fields:mergedFields};
  }
